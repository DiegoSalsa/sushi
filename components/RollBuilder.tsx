      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 m-auto w-full max-w-md h-fit max-h-[calc(100vh-32px)] bg-zinc-900 rounded-xl z-[110] border-2 border-neon shadow-[0_0_30px_rgba(255,153,0,0.6)] flex flex-col overflow-hidden"
          >
            {/* Header */}
